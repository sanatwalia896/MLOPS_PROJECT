...
class DataProcessor:
    ...
    def preprocessed_data(self,df):
        try :
            ...
            logger.info("Droppping unneccesary columns ")
            ...
            logger.info("Lable Encoding appllied")
    ...
    def balanced_data(self,df):
        try :
            ...
            logger.error("Error in data balancing step {e}")
    ...
    def select_features(self,df):
        try:
            ...
            top_10_features=top_features_importance_df['feature'].head(num_features_to_select)
            ...
            logger.error("Error in feature selection step {e}")
